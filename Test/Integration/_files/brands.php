...
$brand
    ...
    ->setBrandName('test_brand_name_600')
    ->setEnabled(1)
    ->setIsFeatured(1)
...
$brand
    ...
    ->setLayoutUpdateXml('layout update xml')
    ->setBrandName('test_brand_name_700')
    ->setEnabled(1)
    ->setIsFeatured(1)
    ->setBrandIcon('testimage.png')
    ->setBrandAdditionalIcon('testimage_additional.png')
...
$brand
    ...
    ->setLayoutUpdateXml('layout update xml')
    ->setBrandName('test_brand_name_40')
    ->setEnabled(1)
    ->setIsFeatured(1)
    ->setBrandIcon('testimage.png');
...
$brand
    ...
    ->setBrandName('test_brand_name_4040')
    ->setEnabled(1)
    ->setIsFeatured(1)
...
$brand
    ...
    ->setLayoutUpdateXml('layout update xml3')
    ->setBrandName('test_brand_name_4050')
    ->setEnabled(1)
    ->setIsFeatured(1)
    ->setBrandIcon('testimage3.png');
